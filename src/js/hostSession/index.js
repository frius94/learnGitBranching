...
var HostSession = Backbone.View.extend({
  ...
  takeControl: function() {
    ...
    Main.getEventBaton().stealBaton('processHostSessionCommand', this.processHostSessionCommand, this);
  ...
  releaseControl: function() {
    ...
    Main.getEventBaton().releaseBaton('processHostSessionCommand', this.processHostSessionCommand, this);
    // a few things to help transition between levels and sandbox
  ...
  processHostSessionCommand: function(command, deferred) {
    // I'm tempted to do cancel case conversion, but there are
    // some exceptions to the rule
    var commandMap = {
      'reset solved': this.resetSolved,
  ...
  helpDialog: function(command, deferred) {
    var helpDialog = new MultiView({
      ...
      childViews: intl.getDialog(require('../dialogs/hostSession'))
    });
