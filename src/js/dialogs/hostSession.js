  ...
  'en_US': [{
    ...
    options: {
      markdowns: [
        ...
        "",
        "<div>",
        "<a href='#' id='hostSessionUrl' style='display: block'></a>",
        "<label for=\"email\">Email</label>",
        "<input type=\"email\" name=\"email\" id=\"email\"/>",
        "<button class=\"btn btn-primary\" id=\"hostSession\">Host Session</button>",
        "<a href='#' id='openDashboard' style='display: block'></a>",
        "</div>"
      ]
    }
  }],
